...
const SDL_events = NS.require('SDL_events')
const SDL_video = NS.require('SDL_video')
const SDL_render = NS.require('SDL_render')
const SDL_rect = NS.require('SDL_rect')
const SDL_pixels = NS.require('SDL_pixels')
const SDL_messagebox = NS.require('SDL_messagebox')
const SDL_keycode = NS.require('SDL_keycode')
const SDL_keyboard = NS.require('SDL_keyboard')
const SDL_mouse = NS.require('SDL_mouse')
